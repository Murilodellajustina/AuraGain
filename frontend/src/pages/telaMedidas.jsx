...
export default function TelaMedidas() {
    ...
    const carregarHistorico = async () => {
        ...
        try {
            ...
            console.error(t("erro_buscar_medidas"), error);
        }
    };
                            ...
                            <div className="card-body p-4">
                                ...
                                {abaAtiva === "NOVA_AVALIACAO" && (
                                    <form onSubmit={handleSalvarAvaliacao} className="px-md-4">
                                        ...
                                        <div className="row g-3 mb-3">
                                            <div className="col-6"><label className="form-label text-muted small fw-bold">{t("label_braco_esquerdo")}</label><input type="number" step="0.1" className="form-control bg-light" name="bracoEsquerdo" value={form.bracoEsquerdo} onChange={handleInputChange} /></div>
